...
attribute @s jump_strength modifier add etcetera:dimension 0.2 add_value
...
attribute @s max_health modifier add etcetera:dimension -0.25 add_multiplied_total
