particle dust{color:0,scale:0.1} ^ ^ ^1.5 0 0 0 0 1 force @a
particle dust{color:0,scale:0.2} ^ ^ ^2 0 0 0 0 1 force @a
particle dust{color:0,scale:0.3} ^ ^ ^2.5 0 0 0 0 1 force @a
particle dust{color:0,scale:0.4} ^ ^ ^3 0 0 0 0 1 force @a
particle dust{color:0,scale:0.5} ^ ^ ^3.5 0 0 0 0 1 force @a
particle dust{color:0,scale:0.6} ^ ^ ^4 0 0 0 0 1 force @a
