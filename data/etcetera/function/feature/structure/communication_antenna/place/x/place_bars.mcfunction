...
execute positioned ~ ~10 ~ as @n[type=marker,tag=etcetera.feature.raycast.iron_bars,distance=..15] positioned ~ ~-10 ~ run function etcetera:feature/structure/communication_antenna/place/x/place_structure
