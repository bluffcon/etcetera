advancement revoke @s only etcetera:feature/block/place/amethyst_exposure_chamber/place
execute if entity @n[type=marker,tag=etcetera.feature.amethyst_exposure_chamber,distance=..10] run return run function etcetera:feature/structure/too_close_multiblock
...
execute as @e[type=marker,tag=etcetera.feature.raycast,distance=..20] at @s if block ~ ~ ~ #etcetera:amethyst_exposure_chamber/copper_trapdoor_blocks run tag @s add etcetera.feature.raycast.trapdoor
kill @e[type=marker,tag=etcetera.feature.raycast,distance=..20,tag=!etcetera.feature.raycast.trapdoor]

execute positioned ~ ~10 ~ as @n[type=marker,tag=etcetera.feature.raycast.trapdoor,distance=..15] positioned ~ ~-10 ~ run function etcetera:feature/structure/amethyst_exposure_chamber/place_structure
kill @e[type=marker,tag=etcetera.feature.raycast.trapdoor,distance=..20]