...
summon drowned ~ ~10 ~ {attributes:[{base:2,id:scale},{base:10,id:attack_damage},{base:2,id:attack_knockback},{base:0.6,id:movement_speed},{base:1,id:"water_movement_efficiency"},{base:120,id:max_health},{base:6,id:entity_interaction_range}],Tags:[smithed.entity,etcetera.entity.deepkeeper],CustomName:{translate:"entity.etcetera.deepkeeper"},DeathLootTable:"etcetera:dimension/gulf_power",equipment:{mainhand:{id:"copper_sword",components:{enchantments:{"sharpness":4,unbreaking:2}}},body:{id:"copper_chestplate",components:{enchantments:{"thorns":2}}},feet:{id:"golden_boots"},offhand:{id:"nautilus_shell"},head:{id:"chiseled_stone_bricks"}},drop_chances:{body:0,feet:0,mainhand:0,offhand:0,head:0},data:{"etcetera":{"boss":"deepkeeper"}},CustomNameVisible:false,active_effects:[{id:"speed",show_particles:false,amplifier:1,duration:-1}]}
